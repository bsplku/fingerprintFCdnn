...
The subdirectories RS1 (or Day1) and RS2 (or Day2) indicate resting-state fMRI sessions from the first and second visits, respectively. Each visit contains two runs with different phase encoding directions, i.e., right-to-left (RL) and left-to-right (LR).
